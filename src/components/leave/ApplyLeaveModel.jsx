...
const ApplyLeaveModel = ({ open, onClose, onSuccess }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop:backdrop-blur-sm"
      onClick={onClose}
    >
      <div
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="">
            <label className="flex items-center gap-2 text-sm font-medium text-slate-700 mb-2">
              <FileText className="w-5 h-4 text-slate-400" />
              Leave Type
            </label>
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-slate-700 mb-2">
              <CalendarDays className="w-5 h-4 text-slate-400" />
              Duration
            </label>
